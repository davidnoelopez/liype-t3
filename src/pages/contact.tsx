...
const Contact = () => {
  ...
  return (
    <section className="mx-auto h-max max-w-screen-md px-4 pb-8 pt-20 md:px-8 lg:py-24">
      ...
      <form className="space-y-8" onSubmit={handleSubmit} noValidate>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8">
          ...
          <TextField
            ...
            type="email"
            label={
              ContactInfo.formEmail.filter((item) => item.locale === locale)[0]
                ?.text
            }
          ...
          <TextField
            ...
            type="tel"
            label={
              ContactInfo.formPhone.filter((item) => item.locale === locale)[0]
                ?.text
            }
          ...
          <TextField
            ...
            type="text"
            label={
              ContactInfo.formState.filter((item) => item.locale === locale)[0]
                ?.text
            }
        ...
        <TextArea
          ...
          rows={5}
          label={
            ContactInfo.formMessage.filter((item) => item.locale === locale)[0]
              ?.text
          }
          placeholder={
