...
const Meta = () => {
  const metaTagsMX = {
    ...
    title: "Licencia de Alcoholes Nuevo León | Tramite Rápido y Seguro",
    description:
      "Obtén tu licencia de alcohol en Nuevo León de forma rápida y sin complicaciones. Nos encargamos de todo el proceso, garantizando un trámite seguro y eficiente.",
