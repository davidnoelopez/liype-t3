        ...
        <div className="w-full space-y-8 px-8 lg:w-1/2">
          <div className="pt-16 sm:pt-10">
            ...
            <div className="mx-6 mt-2 text-center text-lg font-normal text-gray-900 dark:text-gray-100">
              <p className="">
                Tramita tu licencia de alcoholes en el estado de Nuevo León con
                nosotros y ahórrate tiempo en largas filas y evita reiniciar el
                trámite por inexperiencia.
              </p>
              <p className="pt-4">
